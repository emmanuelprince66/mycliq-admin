                            ...
                            <>
                              <Box className="w-full flex justify-center flex-col">
                                ...
                                <div className="mx-auto  w-[70%] h-full flex rounded-[20px] flex-col items-center justify-center bg-white p-4">
                                  ...
                                  <div className="absolute w-full top-[5.9rem] left-[22rem]">
                                    <img
                                      src={zThree}
                                      alt=""
                                  ...
                                  <div className="absolute w-full top-[17.5rem] left-[1rem]">
                                    <img
                                      src={zFour}
                                      alt=""
                                      className="h-[30px] w-[30px]  z-2"
                                  ...
                                  <div className="z-20 border-[5px] rounded-[20px] border-slate-200 p-2  ">
                                    <QRCode
                                      value={qrPayload}
                                      size={206}
                                      level="H"
